...
def extract_languages_snippet_provided(cheatsheet):
    ...
    markers = ["javascript", "java", "csharp", "c", "cpp", "html", "xml", "python",
               ...
               "vbnet"]
    with open("../documentation/" + cheatsheet, encoding="utf8") as cs_file:
...
# Define templates
cs_md_link_template = "[%s](documentation/%s)"
...
index = {}
cs_count = 0
cheatsheets = [f.name for f in os.scandir("../documentation") if f.is_file()]
